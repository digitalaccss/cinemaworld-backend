...
class SearchSetup extends Command
{
    ...
    public function handle(EngineManager $engineManager): void
    {
        ...
        $engine->index('shows_index')->waitForTask($task['taskUid']);
        ...
        $engine->index('instalments_index')->waitForTask($task['taskUid']);
        ...
        $engine->index('cast_index')->waitForTask($task['taskUid']);
        ...
        $engine->index('directors_index')->waitForTask($task['taskUid']);
