...
//class ExportShows extends Action
class ExportShows extends DownloadExcel implements WithMapping, withHeadings
{
    ...
    // {
    //     return Action::message('Shorts download successfully!');
    // }
