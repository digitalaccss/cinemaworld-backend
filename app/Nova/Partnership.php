...
class Partnership extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Hidden::make('Partnership Event Type ID', 'partnership_event_type_id')->default(1),
            ...
            ->maxWidth(150)
            ->disk('public')
            ->path('img/partnership-cover-collection')
            ...
            ->maxWidth(150)
            ->disk('public')
            ->path('img/partnership-banner-collection')
            ->storeAs(function (Request $request){
    ...
    {
        return $query->where('partnership_event_type_id', 1);
    }
